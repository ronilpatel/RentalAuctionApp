    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='property.AddressDetails')),
                ('amenity', models.ManyToManyField(to='property.PropertyAmenities')),
            ],
        ),
        migrations.CreateModel(
            name='PropertyRented',
            fields=[
                ...
                ('prop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='property.PropertyDetails')),
            ],
        ),
        migrations.CreateModel(
            name='UserDetails',
            fields=[
                ...
                ('userprofilephoto', models.ImageField(blank=True, null=True, upload_to='images/')),
                ...
                ('address', models.ManyToManyField(to='property.AddressDetails')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='property.UserDetails')),
            ],
        ),
        migrations.CreateModel(
            name='TourBooking',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='property.PropertyRented')),
            ],
        ),
        migrations.CreateModel(
            name='PropRooms',
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='property.UserDetails'),
        ),
        migrations.CreateModel(
            name='BidRecords',
            fields=[
                ...
                ('auc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='property.AuctionInfo')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='property.UserDetails')),
            ],
        ),
        migrations.AddField(
